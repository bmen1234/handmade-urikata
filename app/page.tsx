...
const faqs = [
  {q:'ハンドメイド作品が売れない理由は何ですか？',a:'主な理由は①価格設定が適切でない②商品タイトルにキーワードが含まれていない③写真のクオリティが低い④ターゲット設定が曖昧、の4つです。まず価格設定と商品タイトルを見直すことで売上が改善するケースが最も多いです。'},
  ...
  {q:'ハンドメイド作品の適正価格はどうやって決めますか？',a:'適正価格は材料費×3〜5倍が基本です。具体的には材料費＋制作時間×時給（最低1,000円）＋販売手数料＋利益を合計して算出します。'},
]
    ...
    <>
      <section className="bg-gradient-to-b from-brand-green-light to-white py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed mb-8">
            価格設定・商品タイトル・説明文・集客・SNS戦略まで。<br/>1,000名以上を指導した実体験をもとに書いています。
          </p>
      ...
      <section className="bg-gray-900 py-6 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-3 gap-4 text-center">
          {[
            {num:'1,000名+',label:'指導したハンドメイド作家'},
            {num:'10年+',label:'ハンドメイド作家としての活動'},
            {num:'毎週更新',label:'実体験ベースの記事'},
          ].map(s=>(
            <div key={s.label}>
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-2xl font-bold text-center text-gray-900 mb-10">あなたの悩みを選んでください</h2>
