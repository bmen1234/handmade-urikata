    ...
    <>
      ...
      <section className="bg-gradient-to-b from-brand-green-light to-white py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
            minneとCreemaで<br className="sm:hidden" />
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed mb-8">
            価格設定・商品タイトル・写真撮影・SNS集客・ブランディングまで。<br />
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/articles?cat=minne" className="btn-secondary text-base px-8 py-4">
              minne攻略を見る
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {latestArticles.map(a => (
            <Link key={a.slug} href={`/articles/${a.slug}`} className="card group flex gap-4">
              <div className="w-16 h-16 bg-brand-green-light rounded-xl flex-shrink-0 flex items-center justify-center text-2xl">
                {a.emoji}
              </div>
              <div>
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="font-serif text-2xl font-bold text-center text-gray-900 mb-10">
            ハンドメイド販売のよくある疑問
          </h2>
