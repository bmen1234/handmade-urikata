...
const nav = [
  ...
  {href:'/tools/price-calculator',label:'価格計算AI'},
  {href:'/tools/title-generator',label:'タイトル生成AI'},
  {href:'/tools/description-writer',label:'説明文AI'},
]
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-gray-100">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link href="/tools/price-calculator" className="hidden sm:inline-flex btn-primary text-sm py-2 px-4">無料AIツール</Link>
